...
def fuzzy_control(pressure_value,pressure_rate_value):
    ...
    # 输出为S的规则
    rule1 = ctrl.Rule(antecedent=((pressure['VH'] & pressure_rate['SL']) |
    ...
    # 输出为M的规则
    rule2 = ctrl.Rule(antecedent=((pressure['VH'] & pressure_rate['FL']) |
    ...
    # 输出为F的规则
    rule3 = ctrl.Rule(antecedent=((pressure['H'] & pressure_rate['FL']) |
